...
import { IconHome } from '../../../config/icons';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="hidden sm:flex items-center gap-8">
              <EnlaceNavegacion href="#sorting" texto={texts.navigation.purge} onClick={(e) => manejarDesplazamiento(e, 'sorting')} />
              {vistaActual === 'home' ? (
                 <a 
                   href="#home" 
                 ...
                 >
                   <IconHome size={18} className="text-zinc-900 dark:text-zinc-400" />
                 </a>
              ) : (
                 <BotonVolver alNavegar={() => alNavegar('home')} />
              )}
              <EnlaceNavegacion href="#replacing" texto={texts.navigation.replace} onClick={(e) => manejarDesplazamiento(e, 'replacing')} />
              <EnlaceNavegacion href="#demo" texto={texts.navigation.demo} onClick={(e) => manejarDesplazamiento(e, 'demo')} />
              <EnlaceNavegacion href="#savings" texto={texts.navigation.savings} onClick={(e) => manejarDesplazamiento(e, 'savings')} />
            </div>
