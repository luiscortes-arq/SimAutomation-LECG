                ...
                <div className="relative bg-white/60 dark:bg-[#0a0f16]/60 backdrop-blur-3xl rounded-2xl p-10 border border-white/40 dark:border-white/5 shadow-2xl">
                    <div className="flex justify-between items-center mb-10 border-b border-zinc-200 dark:border-white/5 pb-6">
                        <div className="flex items-center gap-2">
                             ...
                             <span className="text-hermosillo-mediumBlue font-mono text-[10px] font-bold tracking-widest uppercase">ID: HM_2024_X</span>
                        </div>
                        <div className="px-3 py-1 bg-hermosillo-darkBlue/10 dark:bg-white/5 border border-hermosillo-darkBlue/20 dark:border-white/10 rounded-full text-[9px] text-hermosillo-darkBlue dark:text-white font-mono tracking-wider">AUTO_MODE</div>
                    </div>
                    ...
                    <div className="space-y-8 relative">
                        ...
                        <div className="flex items-center justify-between group relative z-10">
                            <span className="text-zinc-400 font-mono text-xs line-through decoration-hermosillo-red/50">Legacy_V1</span>
                            <motion.div 
                            ...
                            <span className="text-hermosillo-darkBlue dark:text-hermosillo-stateBlue font-mono text-sm font-bold tracking-wide">VDC_Core_V2</span>
                        </div>
                         <div className="flex items-center justify-between opacity-50 relative z-10">
                            <span className="text-zinc-500 font-mono text-xs">Struct_Old</span>
                            <div className="w-1.5 h-1.5 bg-zinc-300 dark:bg-zinc-700 rounded-full z-20"></div>
                            <span className="text-zinc-500 font-mono text-xs">Struct_New</span>
                        </div>
                         <div className="flex items-center justify-between opacity-30 relative z-10">
                            <span className="text-zinc-500 font-mono text-xs">CAD_Import</span>
                            <div className="w-1.5 h-1.5 bg-zinc-300 dark:bg-zinc-700 rounded-full z-20"></div>
                            <span className="text-zinc-500 font-mono text-xs">BIM_Native</span>
                        </div>
                    </div>
        ...
        <div className="order-2">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-hermosillo-gray dark:text-zinc-400 leading-relaxed max-w-md mb-10 font-light">
              <span className="text-hermosillo-mediumBlue font-medium">Conexión inteligente</span> de elementos de Twinmotion.
            </p>

            <div onClick={alNavegar}>
              <Button className="!bg-hermosillo-mediumBlue !hover:bg-hermosillo-darkBlue text-white border-none flex items-center gap-3 px-8 py-4 rounded-full group cursor-pointer shadow-[0_10px_30px_-10px_rgba(63,97,131,0.5)] transition-all hover:scale-105">
                <span className="text-xs font-bold tracking-widest">EJECUTAR</span>
