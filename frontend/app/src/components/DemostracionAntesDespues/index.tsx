...
const PALETTE_CONFIG = [
  { hex: '#EFB628', prefix: 'GLD' }, // Goldenrod PMS 7409C
  { hex: '#6C7D47', prefix: 'PLM' }, // Palm PMS 7490
  { hex: '#542344', prefix: 'WIN' }, // Wine PMS 525
  { hex: '#54494B', prefix: 'TAU' }, // Taupe PMS 438
  { hex: '#028090', prefix: 'SEA' }, // Seaweed PMS 5473C
  { hex: '#C42021', prefix: 'RED' }, // Warm Red PMS 711
];
    ...
    <section className="h-full w-full bg-zinc-100 dark:bg-[#09090b] flex flex-col items-center justify-center px-6 relative transition-colors duration-1000 overflow-hidden">
      ...
      >
        <button 
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800/50 text-hermosillo-gray dark:text-zinc-300 transition-all active:scale-95 cursor-pointer text-xs font-bold uppercase tracking-wider group"
        >
        ...
        <button 
            type="button"
            onClick={sortGrid}
            className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-hermosillo-darkBlue text-white hover:bg-hermosillo-mediumBlue transition-all shadow-md shadow-hermosillo-darkBlue/20 active:scale-95 cursor-pointer"
        >
            <LayoutGrid size={14} />
        ...
        <button 
            ...
            className={`flex items-center gap-2 px-6 py-2.5 rounded-full transition-all duration-500 active:scale-95 shadow-md cursor-pointer border ${
              isReplaced 
                ? 'bg-hermosillo-palm border-hermosillo-palm text-white shadow-hermosillo-palm/30' 
                : 'bg-zinc-100 border-zinc-200 text-hermosillo-gray hover:bg-zinc-200 dark:bg-black/50 dark:border-white/10 dark:text-white'
            }`}
        >
            {isReplaced ? <Check size={14} /> : <Replace size={14} />}
